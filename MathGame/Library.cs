...
public class library
{
    ...
    private Path getPiece()
    {
        if (piece == cross)
        {
            ...
            lines.Margin = new Windows.UI.Xaml.Thickness(10);
            return lines;
        }
        else
        {
            ...
            circle.Margin = new Windows.UI.Xaml.Thickness(10);
            return circle; ;
        }
    }

    // membuat canvas -> create canvas
    ...
    {
        layout(ref grid);
        board[0, 0] = board[0, 1] = board[1, 2] = board[1, 0] = board[1, 1] = board[1, 2] = board[2, 0] = board[2, 1] = board[2, 2] = ""; // inisialisasi nilai awal harus kosong
        won = false;
